...
@section('title', 'Tambah Pegawai - Sistem TNA')
            ...
            <div class="card-body">
                <form action="{{ route('employees.store') }}" method="POST">
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="date" class="form-control @error('current_position_start_date') is-invalid @enderror"
                                       ...
                                       value="{{ old('current_position_start_date') }}">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                <label for="work_experience" class="form-label">Pengalaman Kerja (Tahun) <span class="text-danger">*</span></label>
