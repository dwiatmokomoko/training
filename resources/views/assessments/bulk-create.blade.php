...
@section('title', 'Penilaian Bulk')
@section('page-title', 'Penilaian Bulk')
@section('page-subtitle', 'Input penilaian untuk semua kriteria sekaligus')
...
<div class="row justify-content-center">
    <div class="col-lg-10">
        <div class="card">
            ...
            <div class="card-body">
                <form action="{{ route('assessments.bulk-store') }}" method="POST">
                    @csrf
